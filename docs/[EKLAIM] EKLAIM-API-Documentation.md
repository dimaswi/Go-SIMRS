...
```json
{
  ...
  "data": {
    ...
    "procedure": "99.29",
    "diagnosa_inagrouper": "A09.0,E11.9",
    "procedure_inagrouper": "99.29",
    "tarif_rs": 2500000.00,
    "discharge_status": "1",
    "coder_nik": "1234567890123456"
  }
...
```json
{
  ...
  "response": {
    ...
    "cbg": {
      ...
      "tariff": 3180000.00,
      "tariff_base": 2975000.00,
      "top_up_tariff": 205000.00
    },
    "hospital_tariff": 2500000.00,
    "difference": 680000.00,
...
```json
{
  ...
  "response": {
    ...
    "print_data": {
      ...
      "diagnosis": [
        {"kode": "A09.0", "nama": "Gastroenteritis dan colitis infeksius lainnya", "type": "UTAMA"},
        {"kode": "E11.9", "nama": "Diabetes melitus tipe 2 tanpa komplikasi", "type": "SEKUNDER"}
      ],
      "procedure": [
