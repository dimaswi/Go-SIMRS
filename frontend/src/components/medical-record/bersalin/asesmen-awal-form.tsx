...
const AsesmenDasar = React.memo(({ formData, onChange, isReadOnly }: any) => {
  return (
    <div className="rounded-xl border border-border/60 bg-card text-card-foreground shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 p-3 sm:p-4 bg-slate-50/40 dark:bg-transparent">
        <div className="space-y-1">
          <Label className="text-xs">Jam Datang</Label>
          <TimeInput
        ...
        <div className="space-y-1">
          <Label className="text-xs">Jam Pengkajian</Label>
          <TimeInput
...
const TTVUmum = React.memo(({ fisik, updateFisik, isReadOnly }: any) => {
  return (
    <div className="rounded-xl border border-border/60 bg-card text-card-foreground shadow-sm overflow-hidden">
      ...
      <div className="p-3 sm:p-4 space-y-4 bg-slate-50/40 dark:bg-transparent">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <div className="space-y-1">
            <Label className="text-xs flex items-center gap-1.5">Suhu</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs flex items-center gap-1.5">Nadi</Label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <Label className="text-xs flex items-center gap-1.5">TD</Label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <Label className="text-xs flex items-center gap-1.5">Nafas</Label>
            <div className="relative">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            ...
            <div className="space-y-1">
              <Label className="text-xs">Mata (Konjungtiva)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Mata (Sklera)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Paru-paru</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Payudara (Puting)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Payudara (Colostrum)</Label>
    ...
    <div className="rounded-xl border border-border/60 bg-card text-card-foreground shadow-sm overflow-hidden">
      ...
      <div className="p-3 sm:p-4 space-y-8 bg-slate-50/40 dark:bg-transparent">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
          <div className="space-y-1">
            <Label className="text-xs">Luka bekas operasi</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs">Tinggi fundus uteri</Label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <Label className="text-xs">Posisi janin</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs">Presentasi janin</Label>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
            <div className="space-y-2 lg:col-span-1">
              <Label className="text-xs">His (Frekuensi)</Label>
              <div className="relative">
            ...
            <div className="space-y-2 lg:col-span-1">
              <Label className="text-xs">His (Kekuatan)</Label>
            ...
            <div className="space-y-2 lg:col-span-1">
              <Label className="text-xs">His (Irama)</Label>
            ...
            <div className="space-y-2 lg:col-span-1">
              <Label className="text-xs">DJJ (Frekuensi)</Label>
              <div className="relative">
            ...
            <div className="space-y-2 lg:col-span-1">
              <Label className="text-xs">DJJ (Irama)</Label>
      ...
      <div className="p-3 sm:p-4 space-y-8 bg-slate-50/40 dark:bg-transparent">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4">
            <div className="space-y-1">
              <Label className="text-xs">Serviks (Konsistensi)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Serviks (Pendataran)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Serviks (Posisi)</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Pembukaan</Label>
              <div className="relative">
            ...
            <div className="space-y-1">
              <Label className="text-xs">Selaput Ketuban</Label>
            ...
            {genetalia.selaput_ketuban === "Pecah" && (
              <div className="space-y-1">
                <Label className="text-xs">Jam Ketuban Pecah</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Air Ketuban</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Presentasi Bawah</Label>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
            <div className="space-y-1">
              <Label className="text-xs">Promontorium</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Linea Terminalis</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Arkus Pubis</Label>
      ...
      <div className="p-3 sm:p-4 space-y-8 bg-slate-50/40 dark:bg-transparent">
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            <div className="space-y-1">
              <Label className="text-xs">Turgor Kulit</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Warna Kulit</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Akral</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Kondisi Luka</Label>
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <Label className="text-xs">Gejala Neurologi</Label>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 pt-1">
