  ...
  return (
    <div className="space-y-6 [&_label]:tracking-[0.01em] [&_input:not(.h-9)]:h-10 [&_[role=combobox]:not(.h-9)]:h-10">
      ...
      <div className="p-3 sm:p-4 space-y-8 bg-slate-50/40 dark:bg-transparent">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            <div className="space-y-1">
              <Label className="text-xs">Persepsi terhadap sakitnya</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Status Emosional</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Curiga penganiayaan</Label>
            ...
            <div className="space-y-1">
              <Label className="text-xs">Kebutuhan privasi</Label>
              <div className="flex items-center gap-4">
            ...
            <div className="space-y-2 lg:col-span-2">
              <Label className="text-xs">Kepercayaan khusus / sosial budaya</Label>
              <div className="flex items-center gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 border-t pt-6">
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              <Label className="text-xs">Kebiasaan beribadah</Label>
          ...
          <div className="space-y-4 border-t pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
              <div className="space-y-1">
                <Label className="text-xs">Tempat tinggal</Label>
              ...
              <div className="space-y-1">
                <Label className="text-xs">Keluarga</Label>
              ...
              <div className="space-y-1">
                <Label className="text-xs">Biaya perawatan</Label>
      ...
      <div className="rounded-xl border border-border/60 bg-card text-card-foreground shadow-sm overflow-hidden">
        <div className="border-b border-border/50 bg-muted/40 px-4 py-3 flex items-center gap-2">
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
            Asesmen Nutrisional, Fungsional & Risiko Jatuh
          </div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-border bg-slate-50/40 dark:bg-transparent">
          
          {/* Nutrisional */}
          <div className="p-3 sm:p-4 space-y-6">
            <div className="font-semibold text-primary uppercase tracking-wider text-[11px] border-b pb-2 mb-4">ASESMEN NUTRISI (MUST)</div>
            <div className="space-y-1">
              <Label className="text-xs">LLA (Lingkar Lengan Atas)</Label>
            ...
            <div className="space-y-3 pt-4 border-t border-border/50">
              ...
              <div className="flex items-center gap-3">
                <Input type="number" value={formData.skor_must ?? ""} onChange={(e) => onChange("skor_must", e.target.value ? parseInt(e.target.value) : 0)} disabled={isReadOnly} className="w-24 text-lg font-bold text-center bg-primary/5 border-primary/20" />
          ...
          {/* Fungsional */}
          <div className="p-3 sm:p-4 space-y-6">
            <div className="font-semibold text-primary uppercase tracking-wider text-[11px] border-b pb-2 mb-4">ASESMEN FUNGSIONAL (BARTHEL)</div>
            <div className="space-y-1">
              <Label className="text-xs">Kategori Ketergantungan</Label>
            ...
            <div className="space-y-3 pt-4 border-t border-border/50">
              ...
              <Input type="number" value={formData.skor_barthel ?? ""} onChange={(e) => onChange("skor_barthel", e.target.value ? parseInt(e.target.value) : 0)} disabled={isReadOnly} className="w-24 text-lg font-bold text-center bg-primary/5 border-primary/20" />
            </div>
          </div>

          {/* Jatuh */}
          <div className="p-3 sm:p-4 space-y-6">
            <div className="font-semibold text-primary uppercase tracking-wider text-[11px] border-b pb-2 mb-4">RISIKO JATUH (MORSE)</div>
            <div className="space-y-1">
              <Label className="text-xs">Kategori Risiko</Label>
            ...
            <div className="space-y-3 pt-4 border-t border-border/50">
              ...
              <Input type="number" value={formData.skor_morse ?? ""} onChange={(e) => onChange("skor_morse", e.target.value ? parseInt(e.target.value) : 0)} disabled={isReadOnly} className="w-24 text-lg font-bold text-center bg-primary/5 border-primary/20" />
            </div>
          </div>
      ...
      <div className="p-3 sm:p-4 space-y-6 bg-slate-50/40 dark:bg-transparent">
          <div className="space-y-2 max-w-xs">
            <Label className="text-xs">Apakah ada nyeri?</Label>
          ...
          {nyeri.ada_nyeri === "Ya" && (
            <div className="space-y-8 border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                <div className="space-y-1">
                  <Label className="text-xs">Serangan</Label>
                ...
                <div className="space-y-1">
                  <Label className="text-xs">Waktu Nyeri (Time)</Label>
                ...
                <div className="space-y-1">
                  <Label className="text-xs">Provocating (Penyebab)</Label>
                ...
                <div className="space-y-1">
                  <Label className="text-xs">Quality (Karakteristik)</Label>
                ...
                <div className="space-y-1">
                  <Label className="text-xs">Region (Lokasi penyebaran)</Label>
                  <Input value={nyeri.region || ""} onChange={(e) => updateNyeri("region", e.target.value)} disabled={isReadOnly} />
                </div>
                <div className="space-y-1">
                  <Label className="text-xs">Severate (Tingkat Nyeri)</Label>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label className="text-xs">Kebutuhan penerjemah</Label>
              ...
              <div className="space-y-2">
                <Label className="text-xs">Baca dan tulis</Label>
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-3 gap-x-4 pt-1">
