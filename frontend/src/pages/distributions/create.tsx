...
export default function DistributionCreate() {
  ...
  const requestOptions: ComboboxOption[] = approvedRequests.map((r) => ({
    value: r.id.toString(),
    label: `${r.request_number} - ${r.from_room?.name} (${
      r.items?.filter((i) => i.quantity_approved > i.quantity_fulfilled).length || 0
    } item)`,
  }));
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          {selectedRequest && (
            <>
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedRequest.from_room?.name}
                    </p>
                  </div>
                  <div>
              ...
              {/* Notes Input */}
              <div className="space-y-2">
                <Label>Catatan Distribusi</Label>
                <Input
