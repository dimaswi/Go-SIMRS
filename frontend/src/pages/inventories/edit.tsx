  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="Perbarui identitas, stok minimum-maksimum, serta properti inventaris tanpa berpindah dari halaman master."
        icon={Package}
        actions={
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button type="submit" form="inventory-edit-form" size="sm" disabled={loading}>
      ...
      <PageContent className="flex-none pb-8">
        <div className="mb-4 grid gap-3 lg:grid-cols-3">
          <SummaryCue label="Review Cepat" description="Cek ulang nama, kategori, dan satuan sebelum menyimpan perubahan master." tone="from-background via-background to-sky-50/40" />
          <SummaryCue label="Stok & Nilai" description="Pastikan batas stok tetap logis agar notifikasi inventori tidak bias." tone="from-background via-background to-emerald-50/40" />
          <SummaryCue label="Properti Operasional" description="Perubahan reusable, serial number, dan status aktif memengaruhi pengelolaan item." tone="from-background via-background to-amber-50/50" />
        </div>
        ...
        <form id="inventory-edit-form" onSubmit={handleSubmit} className="space-y-6">
          ...
          <SectionPanel icon={Hash} title="Informasi Stok" description="Stok saat ini bersifat read only, sedangkan ambang minimum dan maksimum tetap bisa diperbarui.">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="space-y-2">
                  <Label
