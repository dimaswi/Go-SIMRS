...
func SetupVisitRoutes(r *gin.Engine) {
	...
	visits.Use(middleware.AuthMiddleware())
	{
		...
		visits.GET("/:id/discharge-planning", handlers.GetDischargePlanning)
		visits.POST("/:id/discharge-planning", handlers.SaveDischargePlanning)
		visits.PUT("/:id/discharge-planning", handlers.SaveDischargePlanning)
		visits.GET("/:id/body-markers", handlers.GetBodyMarkers)
		visits.POST("/:id/body-markers", handlers.SaveBodyMarkers)
		visits.PUT("/:id/body-markers", handlers.SaveBodyMarkers)
